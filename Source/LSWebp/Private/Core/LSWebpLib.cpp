...
#if PLATFORM_WINDOWS
#include "ThirdParty/LSWebpLibrary/mux.h"
#include "ThirdParty/LSWebpLibrary/encode.h"
#include "ThirdParty/LSWebpLibrary/decode.h"
#include "ThirdParty/LSWebpLibrary/demux.h"
#endif
...
bool FLSWebpLibStruct::GenerateWebpByRGBA(const char* InWebpSavePath,
...
bool FLSWebpLibStruct::GenerateDymaicWebpByRGBA(const char* InWebpSavePath,
...
bool FLSWebpLibStruct::LoadDynamicWebpPictureByRGBA(const char* InWebpFilePath, std::vector<const unsigned char*>& OutRGBADatas, std::vector<int>& OutTimestamps_ms, int& OutWidth, int& OutHeight )
{
#if PLATFORM_WINDOWS
	bool bSucceed = true;
...
bool FLSWebpLibStruct::ResizeDynamicWebp(const char* InResizedWebpPath,
