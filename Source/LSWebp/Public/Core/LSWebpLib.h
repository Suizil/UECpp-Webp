 ...
 * if you want to do more about webp,you can read LSWebp/LSWebpLibrary/*.h,which contain anything you can with webp
 */
struct FLSWebpLibStruct
{
	friend class FLSWebpCore;
protected:
